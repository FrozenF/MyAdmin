...
class BuilderMakeViewEdit extends Command
{
    /**
    ...
    protected $signature = 'my-build:view-edit {name} {--column=} {--pk=}';
    ...
    protected function replaceArgument($stub)
    {
        ...
        foreach($this->columns as $col)
        {
            ...
            $input = str_replace('##value_edit##','$item->'.$col->nama_kolom,$input);
            $column .= $input;
        }
    ...
    {
        $slug = Str::slug($name,'_');
        return "resources/views/{$slug}/edit.blade.php";
    }
